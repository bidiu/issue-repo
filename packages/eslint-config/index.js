module.exports = {
  ...
  plugins: [
    'eslint-comments',
    'react',        // TODO move this with following line, and more to specific packages
    'react-hooks',  // we have hook code even in archon-common, put it here for convenience
  ],
  settings: {
    react: {
      version: 'detect',
  ...
  rules: {
    // We use prettier as formatter (but need to manually execute). Because it's too annoying while coding, it's disaled here.
    // You still have the ability formatting your code using prettier. To opt in, justy press "Shift + Alt + F".
    // The extended config 'plugin:prettier/recommended' makes sure no eslint rules will be violated after prettier formats code.
    'prettier/prettier': 'off',

    // General
    'comma-dangle': 0, // [1, 'always-multiline'], // allow or disallow trailing commas
    ...
    'quotes': 'off', // [1, 'single', 'avoid-escape'], // specify whether double or single quotes should be used
